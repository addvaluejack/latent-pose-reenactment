...
DATASET_ROOT="/home/jiangmuye/Projects/latent-pose-reenactment/dataset"
IDENTITY_NAME="jing"
MAX_BATCH_SIZE=8             # pick the largest possible, start with 8 and decrease until it fits in VRAM
CHECKPOINT_PATH="/home/jiangmuye/Projects/latent-pose-reenactment/data/model/pretrained.pth"
OUTPUT_PATH="outputs/"       # a directory for outputs, will be created
RUN_NAME="jing"  # give your run a name if you want
